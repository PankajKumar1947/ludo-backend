...
import { addCoins, deductCoins, deletePlayer, getAllPlayers, getPlayerById } from "../controllers/admin/players.js";
...
router.get("/player/:id", isAuthenticated, isAdmin, getPlayerById);
